...
export class TelegramClient {
  constructor() {
    ...
    this.apiId = process.env.TELEGRAM_API_ID || '94575';
    this.apiHash = process.env.TELEGRAM_API_HASH || 'a3406de8d171bb422bb6ddf3bbd800e2';
    ...
    return new Promise((resolve) => {
      ...
      switch (string) {
        ...
        default:
          ...
          defaultHandler(args).then(resolve);
          return;
      }
